"""
Django settings for Blood_Donation_Backend project.
...
DATABASES = {
    'default': {
        ...
        'USER': 'postgres.corrsqofdvgynealfkuz',  # Replace this with your actual username
        'PASSWORD': env("PASSWORD_DATABASE"),  # Ensure this is set in .env
