...
from .serializers  import RequestForBloodModelSerializer
...
class RequestForBloodModelView(ModelViewSet):
    
    serializer_class=RequestForBloodModelSerializer
    ...
    def get_queryset(self):
        ...
        print(request_id)
        queryset=models.RequestForBloodModel.objects.all()
        user_id=self.request.query_params.get('user_id')
        blood_group=self.request.query_params.get('blood')

        """
        Return the queryset for RequestForBloodModel.
